<template>
        <aside class="col-4 align-items-center row aside__bloc">

            <h2 class="col-12 text-center mb-3 aside__bloc--title">Sélectionne une émotion :</h2>              
            ...
            <h2 class="mb-2 mt-3 aside__bloc--title">Légende, catégorie des émotions</h2>

            <div class="d-flex align-items-center col-12 legend" v-for="item in emotionsList.main" :key="item.feel">
